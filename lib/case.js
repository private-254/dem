...
const MAX_CACHE = 1000; // Maximum messages to store
...
function ensureDirectories() {
    try {
        ...
        try {
            ...
            global.antiDeleteEnabled = state.enabled !== false; // Default to true
        } catch {
...
const antideleteSettings = {
    ...
    isEnabled: () => {
        return global.antiDeleteEnabled !== false;
    },
    clearCache: () => {
...
export {
    ...
    handleGroupParticipantUpdate, // Export the new handler
