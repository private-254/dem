...
const os = require('os')
let trashplug = async (m, { reply,davetech }) => {
await m.reply(`𝒄𝒐𝒅𝒆𝒔 𝒔𝒑𝒆𝒂𝒌 𝒍𝒐𝒖𝒅𝒆𝒓 𝒕𝒉𝒂𝒏 𝒕𝒉𝒆 𝒂𝒄𝒕𝒖𝒂𝒍 𝒘𝒐𝒓𝒅𝒔,𝒄𝒉𝒆𝒄𝒌𝒊𝒏𝒈 davetech 𝒔𝒑𝒆𝒆𝒅.........`)
  ...
  const finalStatus = `davetech 𝒔𝒚𝒔𝒕𝒆𝒎: ${latency.toFixed(4)} ms`;
  m.reply(finalStatus);
};  
trashplug.help = ['ping']
