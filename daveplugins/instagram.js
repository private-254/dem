...
async function instagramCommand(sock, chatId, message) {
    try {
        ...
        if (mediaToDownload.length === 0) {
            return await sock.sendMessage(chatId, { 
                text: "🙂‍↔️I found no valid media found to download. This might be a private post or the scraper failed."
            });
        }
        ...
        await sock.sendMessage(chatId, { 
            text: "huh👎 An error occurred while processing the Instagram request. Please try again."
        });
    }
}
