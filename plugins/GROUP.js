        ...
        try {
           ...
           /** if (targetsToRemove.length === 0) {
            ...
            /**const resultText =
                ...
                `📜 Details:\n${results.join("\n")}\n\n` +
                `Members removed by DAVE-MD BOT 🤖`;
        ...
        try {
            ...
            await context.reply( {
                ...
                text: `📋 Group Information\n\n` +
                      ...
                      `Group ID retrieved by DAVE-MD BOT 🤖`
