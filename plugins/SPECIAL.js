...
export default [ 
    ...
    async execute(sock, m, args, context) {
        try {
            ...
            // Fetch repo info
            const res = await fetch('https://api.github.com/repos/Daveeddevsmd/DAVE-MD', {
            ...
            const zipUrl = `https://github.com/Daveeddevsmd/DAVE-MD/archive/refs/heads/main.zip`;
